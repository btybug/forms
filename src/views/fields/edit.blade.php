...
@section('content')
       <div class="col-md-12  m-t-20" id="add-new-fields">
           {!! Form::model($field,['class' => 'form-horizontal','id' => 'edit-field']) !!}
           <div class="row">
               <div class="col-md-6">
                       ...
                       <div class="form-group col-md-12">
                           <div class="form-group col-md-4">
                               ...
                               <div class="col-md-9">
                                   ...
                                   <div class="form-control" readonly="true" disabled="true"> </div>
                               </div>
           ...
           <input type="text" class="hide" data-fieldtype="form" name="fieldhtmltype" value="">
